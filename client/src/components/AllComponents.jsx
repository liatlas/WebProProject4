// ============================================================================
// ALL REMAINING COMPONENTS - Combined file for smaller components
// ============================================================================
            ...
            <div className="modal victory-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="victory-stats">
                    <div className="victory-stat">
                        ...
                        <div className="stat-value">{Math.floor(data.time / 60)}:{(data.time % 60).toString().padStart(2, '0')}</div>
                    </div>
                    <div className="victory-stat">
                ...
                <div className="victory-badges">
                    {data.perfectGame && (
                        <div className="badge perfect-badge">
                            🎯 Perfect Game!
                        </div>
                    )}
                    {data.speedBonus && (
                    ...
                    {data.leveledUp && (
                        <div className="badge levelup-badge">
                            ⬆️ Level {data.newLevel}!
                        </div>
                    )}
                </div>
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal story-modal" onClick={(e) => e.stopPropagation()}>
                <div className="story-header">
                    <h2>Act {segment.act}: {segment.title}</h2>
                </div>
                    ...
                    currentLeaderboard.map((entry, index) => (
                        ...
                        >
                            ...
                            <div className="entry-user">
                                <div className="user-name">{entry.display_name || entry.username}</div>
...
// USER PROFILE
// ============================================================================
export function UserProfile({ user, stats, achievements, onBack, onUpdateProfile }) {
...
export function AchievementPanel({ achievements, userAchievements, onBack }) {
    const categories = ['all', 'gameplay', 'speed', 'efficiency', 'competitive', 'special'];
        ...
        <div className="achievements-screen">
            ...
            <div className="achievements-grid">
                {filteredAchievements.map(achievement => {
                    ...
                    const percentage = (currentProgress / achievement.requirement_value) * 100;
        ...
        <div className="powerups-screen">
            ...
            <div className="powerups-grid">
                {powerups.map(powerup => {
                    const userPowerup = userPowerups.find(up => up.powerup_id === powerup.powerup_id);
                    const quantity = userPowerup?.quantity || 0;

                    return (
                        <div key={powerup.powerup_id} className={`powerup-card rarity-${powerup.rarity}`}>
                            <div className="powerup-header">
                                <div className="powerup-icon-large">{getPowerupIcon(powerup.powerup_key)}</div>
                            ...
                            <div className="powerup-meta">
                                ...
                                {powerup.usable_in_multiplayer && <span className="tag">Multiplayer</span>}
                                {powerup.usable_in_competitive && <span className="tag">Competitive</span>}
                            </div>
                        </div>
                    );
                })}
...
function getPowerupIcon(key) {
    const icons = {
        'peek': '👁️', 'hint': '💡', 'shuffle_helper': '🔄', 'time_freeze': '⏰',
        'auto_solve_3': '🎯', 'undo_move': '↩️', 'slow_motion': '🐌', 'ghost_tile': '👻'
    };
    return icons[key] || '✨';
}
...
// SETTINGS PANEL
// ============================================================================
export function SettingsPanel({ preferences, currentTheme, onUpdatePreferences, onChangeTheme, onBack, availableThemes }) {
                ...
                <div className="settings-section">
                    ...
                    <label className="setting-item">
                        ...
                        <input
                            ...
                            onChange={(e) => setPrefs({ ...prefs, music_enabled: e.target.checked })}
                        />
                    </label>
                    <label className="setting-item">
                    ...
                    <label className="setting-item">
                        ...
                        <input
                            ...
                            onChange={(e) => setPrefs({ ...prefs, music_volume: parseFloat(e.target.value) })}
                        />
                    </label>
                    <label className="setting-item">
                        ...
                        <input
                            ...
                            onChange={(e) => setPrefs({ ...prefs, sound_volume: parseFloat(e.target.value) })}
                        />
                    </label>
                </div>
                ...
                <div className="settings-section">
                    ...
                    <label className="setting-item">
                        ...
                        <input
                            ...
                            onChange={(e) => setPrefs({ ...prefs, show_timer: e.target.checked })}
                        />
                    </label>
                    <label className="setting-item">
                        ...
                        <input
                            ...
                            onChange={(e) => setPrefs({ ...prefs, show_move_counter: e.target.checked })}
                        />
                    </label>
                    <label className="setting-item">
                        ...
                        <input
                            ...
                            onChange={(e) => setPrefs({ ...prefs, enable_animations: e.target.checked })}
                        />
                    </label>
                </div>
                    ...
                    <div className="theme-selector">
                        {themes.map(theme => (
                            <button
                                ...
                                onClick={() => availableThemes.includes(theme) && onChangeTheme(theme)}
